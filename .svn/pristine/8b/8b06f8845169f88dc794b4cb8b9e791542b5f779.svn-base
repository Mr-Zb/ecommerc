...
public class FinCapitalLogService extends BaseService {
    ...
    public Pagination<FinCapitalLog> select(FinCapitalLog paramInteger, QueryDto queryDto, Integer c) {
        PageHelper.startPage(queryDto.getPage(), queryDto.getRows(), true);
        Page<FinCapitalLog> page = this.finCapitalLogMapper.select(paramInteger, queryDto, c);
