...
public class SysPropSettingService {
	...
	public void updateActiveNew(Integer userId,String sysPropSetting1,String sysPropSetting2,String sysPropSettingAnd,String sysPropSettingIos,
								String sysPictureAnd,String sysPictureIos,String sysPropSetting4,String[] param1,String[] param2,String alipayAccount
			,String alipayName,String alipayCode,String wepayAccount
			,String wepayName,String wepayCode,String qq){
		...
		sysPropSettingw.setPropKey("sys.download.and");
		SysPropSetting sysPropSettinggt = new SysPropSetting();
		sysPropSettinggt.setPropValue(sysPropSettingAnd);
		sysPropSettingMapper.updateActive(sysPropSettinggt,sysPropSettingw);
		//修改ios下载地址
		SysPropSetting ios = new SysPropSetting();
		ios.setPropKey("sys.download.ios");
		SysPropSetting sysPropSettinggtdd = new SysPropSetting();
		sysPropSettinggtdd.setPropValue(sysPropSettingIos);
		sysPropSettingMapper.updateActive(sysPropSettinggtdd,ios);
		//修改android二维码
		SysPropSetting picture = new SysPropSetting();
		picture.setPropKey("sys.picture.and");
		SysPropSetting picture1 = new SysPropSetting();
		picture1.setPropValue(sysPictureAnd);
		sysPropSettingMapper.updateActive(picture1,picture);
		//修改ios二维码
		SysPropSetting iospicture = new SysPropSetting();
		iospicture.setPropKey("sys.picture.ios");
		SysPropSetting iospicture1 = new SysPropSetting();
		iospicture1.setPropValue(sysPictureIos);
		sysPropSettingMapper.updateActive(iospicture1,iospicture);
		//修改公告信息
		...
		//修改客服QQ
		SysPropSetting serviceqq = new SysPropSetting();
		serviceqq.setPropKey("sys.service.qq");
		SysPropSetting serviceqq11 = new SysPropSetting();
		serviceqq11.setPropValue(qq);
		sysPropSettingMapper.updateActive(serviceqq11,serviceqq);
		//删除首页轮播图信息
		if (param1.length>0){
	...
	public List<SysPropSetting> selectDataVersion(){
		return this.sysPropSettingMapper.selectDataVersion();
	}

	public String selectMessage(String propKey){
		return this.sysPropSettingMapper.selectMessage(propKey);
	}
