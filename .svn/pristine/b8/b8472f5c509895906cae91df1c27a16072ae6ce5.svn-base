...
public class UserPlaceOrderService extends BaseService {
    ...
    public String OpenRedEnvelope(Integer userId, Integer goodsId) throws BusinessException {
        ...
        if (reandom == 1) {
            ...
            goodsOrderInfo.setPayMoney(payMoney*memUserInfo1.getExtension());
        } else {
        ...
        if (reandom == 1) {
            ...
            //更新用户中奖金额
            memUserInfo.setCapital6(capital6 + goodsInfo.getPrice() * memUserInfo1.getExtension());
            ...
            //给代理加钱
            if (0 == memUserInfo1.getAgentId()) {
                memUserInfoService.updateUserAmount1(memUserInfo1.getPkId(), memUserInfo1.getCapital1() + memUserInfo1.getRebate() * payMoney + (1.9 - memUserInfo1.getExtension()) * payMoney);
            } else {
                memUserInfoService.updateUserAmount1(memUserInfo1.getPkId(), memUserInfo1.getCapital1() + memUserInfo1.getRebate() * payMoney + (memUserInfo11.getExtension() - memUserInfo1.getExtension()) * payMoney);//推广盈利
            }
            return "恭喜您，拆中了" + goodsInfo.getPrice() * memUserInfo1.getExtension() + "元的（" + goodsInfo1.getGoodName() + "）x1";
        } else {
            this.memUserInfoService.updateUserAmount1(memUserInfo1.getPkId(), memUserInfo1.getCapital1() + memUserInfo1.getRebate() * payMoney);
