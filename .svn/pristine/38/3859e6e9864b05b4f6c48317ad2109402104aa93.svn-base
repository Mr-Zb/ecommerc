...
public class MemUserInfoService extends BaseService {
    ...
    //@Log("修改密码")
    @Transactional(propagation = Propagation.REQUIRED, rollbackFor = {Exception.class}, readOnly = false)
    public Integer updatePwdById(Integer userId, String pwd1, String pwd2) throws Exception {
      return this.memUserInfoMapper.updatePwdById(userId,DigestUtils.md5Hex(pwd1), DigestUtils.md5Hex(pwd2));
    }
    ...
    public  Double teamCapital6(Integer userId){
        return this.memUserInfoMapper.teamCapital6(userId);
    }
    ...
    //test
    public List<MemUserInfo> testTeamMoney(Integer agentId){
        return this.memUserInfoMapper.testTeamMoney(agentId);
    }
    ...
    public Integer updateGoogle(MemUserInfo userInfo){
        return this.memUserInfoMapper.updateGoogle(userInfo);
    }
    public MemUserInfo selectByCampaign(String campaign){
        return  memUserInfoMapper.selectByCampaign(campaign);
    }
}
