...
//			this.memUserInfoMapper.updateUserAmount1(uid, finCapitalLog.getCapitalAmount2());//更新用户余额
		}
	}
	@Transactional(propagation = Propagation.REQUIRED, readOnly = false, rollbackFor = { Exception.class })
	public void drawApplier(Integer userId,Double amount) throws BusinessException {
		...
		this.memUserInfoMapper.updateUserAmount1(userId,_amount - finWithdrawLog.getWithdrawAmount2());//更新用户余额
