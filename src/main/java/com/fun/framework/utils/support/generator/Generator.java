package com.fun.framework.utils.support.generator;

import static com.fun.framework.utils.support.generator.XRandoms.alpha;
import static com.fun.framework.utils.support.generator.XRandoms.num;
...
public abstract class Generator {
	 ...
	 *  only @see com.fun.framework.utils.support.generator.Captcha#write2out(OutputStream os) avaliable for GIF
	 * @return
